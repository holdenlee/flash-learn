...
var _user$project$Utilities$cmdReturn = function (x) {
	return A3(
...
var _user$project$Utilities$dropWhile = F2(
	function (f, li) {
		dropWhile:
		while (true) {
			var _p0 = li;
...
var _user$project$Utilities$tail$ = function (_p1) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$List$tail(_p1));
};
var _user$project$Utilities$last = function (_p2) {
	return _elm_lang$core$List$head(
		_elm_lang$core$List$reverse(_p2));
};
var _user$project$Utilities$zip = _elm_lang$core$List$map2(
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
		}));

var _user$project$FlashCards$flashCard = F2(
	function (x, y) {
		return {front: x, back: y};
	});
var _user$project$FlashCards$getCurrentCard$ = function (m) {
	return A2(_elm_lang$core$Dict$get, m.current, m.dict);
};
var _user$project$FlashCards$getCurrentCard = function (_p0) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		A2(_user$project$FlashCards$flashCard, '', ''),
		_user$project$FlashCards$getCurrentCard$(_p0));
};
var _user$project$FlashCards$check = function (m) {
	return _elm_lang$core$Native_Utils.eq(
		m.curText,
		_user$project$FlashCards$getCurrentCard(m).back);
};
var _user$project$FlashCards$updateMovingAvg = F3(
	function (c, x, y) {
		return (c * x) + ((1 - c) * y);
	});
var _user$project$FlashCards$temperature = F2(
	function (c, x) {
		return Math.pow(_elm_lang$core$Basics$e, c * x);
	});
var _user$project$FlashCards$pickUsingNumber = function (n) {
	return function (_p1) {
		return A2(
			...
			_elm_lang$core$List$head(
				A2(
					_user$project$Utilities$dropWhile,
					function (_p2) {
						return function (x) {
							return _elm_lang$core$Native_Utils.cmp(x, n) < 1;
						}(
...
var _user$project$FlashCards$pick = F2(
	function (tempF, d) {
		var vs = _elm_lang$core$Dict$values(d);
		var partials = _user$project$Utilities$tail$(
			A3(
				...
				0,
				A2(_elm_lang$core$List$map, tempF, vs)));
		var total = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			_user$project$Utilities$last(partials));
		var pairs = A2(
			_user$project$Utilities$zip,
			_elm_lang$core$Dict$keys(d),
			partials);
		return A2(
			_elm_lang$core$Random$generate,
			function (x) {
				return A2(_user$project$FlashCards$pickUsingNumber, x, pairs);
			},
			A2(_elm_lang$core$Random$float, 0, total));
	});
var _user$project$FlashCards$modelPickNew = F2(
	function (model, p) {
		return A2(
			_elm_lang$core$Platform_Cmd$map,
			_elm_lang$core$Maybe$withDefault(''),
			A2(
				_user$project$FlashCards$pick,
				model.tempF(
					model.tempSchedule(model.step)),
				p));
	});
var _user$project$FlashCards$Session = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {progress: a, dict: b, tempF: c, tempSchedule: d, getScore: e, current: f, step: g, avgFunc: h, startTime: i, endTime: j, curText: k, avgTime: l, reviewing: m};
												};
											};
										};
									};
...
var _user$project$FlashCards$BasicFlashCard = F2(
	function (a, b) {
		return {front: a, back: b};
	});
var _user$project$FlashCards$SetReview = function (a) {
	return {ctor: 'SetReview', _0: a};
};
var _user$project$FlashCards$Next = function (a) {
	return {ctor: 'Next', _0: a};
};
var _user$project$FlashCards$SetEndTime = function (a) {
	return {ctor: 'SetEndTime', _0: a};
};
var _user$project$FlashCards$SetStartTime = function (a) {
	return {ctor: 'SetStartTime', _0: a};
};
var _user$project$FlashCards$update$ = F3(
	function (def, msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'Finished':
				var _p5 = _p3._0;
				var elapsed = _p3._1 ? _elm_lang$core$Maybe$Just((_p5 - model.startTime) / _elm_lang$core$Time$second) : _elm_lang$core$Maybe$Nothing;
				var f = function (x) {
					return A2(
						model.avgFunc,
						x,
						A2(
							...
							A2(
								_elm_lang$core$Maybe$withDefault,
								def,
								_user$project$FlashCards$getCurrentCard$(model)),
							elapsed));
				};
				var newProgress = A3(
					_elm_lang$core$Dict$update,
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							startTime: _p5,
							avgTime: function () {
								var _p4 = {ctor: '_Tuple2', _0: model.avgTime, _1: elapsed};
								if (_p4._0.ctor === 'Nothing') {
									return _p4._1;
								} else {
									if (_p4._1.ctor === 'Just') {
										return _elm_lang$core$Maybe$Just(
											A2(model.avgFunc, _p4._0._0, _p4._1._0));
									} else {
			...
			case 'GetNext':
				return {
					...
					_1: A2(
						_elm_lang$core$Platform_Cmd$map,
						_user$project$FlashCards$Next,
						A2(_user$project$FlashCards$modelPickNew, model, model.progress))
				};
			case 'Next':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{current: _p3._0, curText: ''}),
					_1: _user$project$Utilities$cmdReturn(
						_user$project$FlashCards$SetReview(false))
				};
			case 'Init':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(_elm_lang$core$Task$perform, _elm_lang$core$Basics$identity, _user$project$FlashCards$SetStartTime, _elm_lang$core$Time$now)
				};
			case 'SetStartTime':
				return {
					ctor: '_Tuple2',
...
var _user$project$FlashCards$update = _user$project$FlashCards$update$(
	A2(_user$project$FlashCards$flashCard, '', ''));
var _user$project$FlashCards$test = {
	ctor: '_Tuple2',
	_0: {
		progress: _elm_lang$core$Dict$fromList(
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: '1', _1: 10},
		...
		dict: _elm_lang$core$Dict$fromList(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: '1',
					_1: A2(_user$project$FlashCards$flashCard, '1f', '1b')
				},
					{
					ctor: '_Tuple2',
					_0: '2',
					_1: A2(_user$project$FlashCards$flashCard, '2f', '2b')
				}
				])),
		tempF: _user$project$FlashCards$temperature,
		tempSchedule: function (n) {
			return _elm_lang$core$Native_Utils.eq(
		...
		getScore: F2(
			function (card, mTime) {
				...
				if (_p6.ctor === 'Nothing') {
					...
					return A2(_elm_lang$core$Basics$min, 5, _p6._0);
				}
			}),
		current: '',
		step: 0,
		avgFunc: _user$project$FlashCards$updateMovingAvg(0.9),
		startTime: 0,
		endTime: 0,
		curText: '',
		avgTime: _elm_lang$core$Maybe$Nothing,
		reviewing: false
	},
	_1: A3(_elm_lang$core$Task$perform, _elm_lang$core$Basics$identity, _user$project$FlashCards$SetStartTime, _elm_lang$core$Time$now)
};
var _user$project$FlashCards$GetNext = {ctor: 'GetNext'};
var _user$project$FlashCards$Init = {ctor: 'Init'};
var _user$project$FlashCards$Finished = F2(
	function (a, b) {
		return {ctor: 'Finished', _0: a, _1: b};
	});
...
var _user$project$View$Text = function (a) {
...
var _user$project$KeyCodes$left = 37;
var _user$project$KeyCodes$up = 38;
...
var _user$project$FlashLearn$RequestTime = function (a) {
	return {ctor: 'RequestTime', _0: a};
};
var _user$project$FlashLearn$InternalAction = function (a) {
	return {ctor: 'InternalAction', _0: a};
};
var _user$project$FlashLearn$finish$ = F3(
	function (correct, review, time) {
		return _user$project$FlashLearn$Msgs(
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$FlashLearn$InternalAction(
						A2(_user$project$FlashCards$Finished, time, correct))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						review ? _user$project$FlashLearn$InternalAction(
						_user$project$FlashCards$SetReview(true)) : _user$project$FlashLearn$InternalAction(_user$project$FlashCards$GetNext)
					])));
	});
var _user$project$FlashLearn$finish = F2(
	function (m, time) {
		var c = _user$project$FlashCards$check(m.session);
		return A3(
			_user$project$FlashLearn$finish$,
			c,
			A2(_user$project$FlashLearn$whetherToReview, c, m),
			time);
	});
...
var _user$project$FlashLearn$view = function (m) {
	return A2(
		_elm_lang$html$Html_App$map,
		_user$project$FlashLearn$UserAction,
		A8(
			_user$project$View$makePage,
			_user$project$View$Text(
				_user$project$FlashCards$getCurrentCard(m.session).front),
			m.session.reviewing ? _user$project$View$Text(
				_user$project$FlashCards$getCurrentCard(m.session).back) : _user$project$View$Text(''),
			m.session.curText,
			A2(_elm_lang$core$Maybe$withDefault, 9999, m.session.avgTime),
			A2(
				_elm_lang$core$Maybe$withDefault,
				0,
				A2(
...
var _user$project$FlashLearn$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$FlashLearn$init, view: _user$project$FlashLearn$view, update: _user$project$FlashLearn$update, subscriptions: _user$project$FlashLearn$subscriptions})
};

var Elm = {};
Elm['FlashLearn'] = Elm['FlashLearn'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['FlashLearn'], 'FlashLearn', typeof _user$project$FlashLearn$main === 'undefined' ? null : _user$project$FlashLearn$main);
