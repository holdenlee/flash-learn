...
var _user$project$Buttons$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: 0, view: _user$project$Buttons$view, update: _user$project$Buttons$update})
};

var Elm = {};
Elm['Buttons'] = Elm['Buttons'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Buttons'], 'Buttons', typeof _user$project$Buttons$main === 'undefined' ? null : _user$project$Buttons$main);
